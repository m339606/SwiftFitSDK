public class PowerZoneMesg : Mesg {
    ...
    public init() {
        super.init(mesg: Profile.getMesg(globalMesgNum: MesgNum.PowerZone))
    }
    ...
    public func setHighValue(_ highValue: UInt16) {
        setFieldValue(fieldNum: 1, fieldArrayIndex: 0, value: highValue, subfieldIndex: Fit.subfieldIndexMainField)
    }
